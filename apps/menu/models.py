...
class ReservoirModel(models.Model):
    reservoir_name = models.CharField(max_length=50, verbose_name='水库名')
    storage_area = models.IntegerField(verbose_name='蓄水面积')
    water_level = models.FloatField(max_length=20, verbose_name='水位')
    watershed_area = models.IntegerField(verbose_name='流域面积')
    irrigation_area = models.IntegerField(verbose_name='灌溉面积')
...
class HruModel(models.Model):
    ...
    YEAR = models.IntegerField(verbose_name='年份', default=2000)
